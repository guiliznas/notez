...
import { collection, query, where, onSnapshot, addDoc, updateDoc, doc, deleteDoc, setDoc } from 'firebase/firestore';
...
const INITIAL_GROUPS: Group[] = [
    { id: '1', title: 'Ideias de Projetos', lastActive: Date.now() - 1000 * 60 * 30, snippet: 'Precisamos validar a API...', isArchived: false },
    { id: '2', title: 'Tarefas de Casa', lastActive: Date.now() - 1000 * 60 * 60 * 24, snippet: 'Comprar leite e ovos', isArchived: false },
];

const INITIAL_MESSAGES: Message[] = [
    { id: 'm1', groupId: '1', text: 'Bom dia! Vamos revisar o material de hoje.', senderId: 'other', timestamp: Date.now() - 1000000 },
    { id: 'm2', groupId: '1', text: 'Claro, estou pronto.', senderId: 'me', timestamp: Date.now() - 900000 },
];

const INITIAL_EVENTS: CalendarEvent[] = [
    { id: 'e1', title: 'Reunião de planejamento', startTime: '10:00', endTime: '11:00', dateLabel: 'Hoje' },
    { id: 'e2', title: 'Sessão de brainstorming', startTime: '14:00', endTime: '15:00', dateLabel: 'Hoje' },
    { id: 'e3', title: 'Revisão de design', startTime: '16:00', endTime: '17:00', dateLabel: 'Hoje' },
    { id: 'e4', title: 'Almoço com equipe', startTime: '12:00', endTime: '13:00', dateLabel: 'Amanhã' },
];
...
export const AppProvider = ({ children }: { children?: ReactNode }) => {
    ...
    useEffect(() => {
        const unsubscribeAuth = onAuthStateChanged(auth, (firebaseUser) => {
            if (firebaseUser) {
                ...
                const unsubUserData = subscribeToUserData(firebaseUser.uid);
    ...
    const subscribeToUserData = (uid: string) => {
        ...
        const qMessages = query(collection(db, "messages"), where("userId", "==", uid));
    ...
    const mockCalendarFetch = (uid: string) => {
        setEvents(prev => [
            ...prev,
            { id: 'synced_1', title: `Reunião Sincronizada`, startTime: '09:00', endTime: '10:00', dateLabel: 'Hoje' }
        ]);
    };
